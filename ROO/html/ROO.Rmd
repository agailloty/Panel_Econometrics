...
La méthode des moindres carrés permet ainsi d'établir une causalité entre les variables x et y. Cette causalité va au-delà d'une simple corrélation. En économie, la méthode des OLS est utilisée pour trouver les relations causales et bien souvent une seule variable ne suffit pas à expliquer un phénomène en particulier.  
